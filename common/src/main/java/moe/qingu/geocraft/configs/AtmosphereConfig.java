...
import moe.qingu.geocraft.api.atmosphere.config.AtmosphereSystemInfo;
import moe.qingu.geocraft.api.configs.value.map.entry.BlockIntegerEntry;
import moe.qingu.geocraft.api.configs.value.map.entry.ConfigEntry;
import moe.qingu.geocraft.api.configs.value.minecraft.ConfigurableBlockProperty;
import moe.qingu.geocraft.api.configs.value.minecraft.ConfigurableBlockState;
import moe.qingu.geocraft.api.setting.GeoAtmosphereSetting;
import moe.qingu.geocraft.api.setting.GeoBlockSetting;
import moe.qingu.geocraft.api.configs.item.map.ConfigMap;
import moe.qingu.geocraft.geography.atmosphere.info.CloseAtmosphereSystemInfo;
import moe.qingu.geocraft.geography.atmosphere.info.SurfaceAtmosphereSystemInfo;
import moe.qingu.geocraft.geography.atmosphere.info.VanillaAtmosphereSystemInfo;
import moe.qingu.geocraft.geography.atmosphere.system.CloseAtmosphereSystem;
