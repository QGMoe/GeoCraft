...
import moe.qingu.geocraft.command.atmosphere.AtmosphereAdds;
import moe.qingu.geocraft.command.atmosphere.AtmosphereQueries;
import moe.qingu.geocraft.command.atmosphere.AtmosphereSets;
import moe.qingu.geocraft.command.atmosphere.CommandAtmosphere;
import moe.qingu.geocraft.test.GeoTest;
...
import static moe.qingu.geocraft.command.atmosphere.CommandAtmosphere.ATMOSPHERE_COMMAND_NAME;
import static moe.qingu.geocraft.command.atmosphere.CommandAtmosphere.getPropertyList;
import static moe.qingu.geocraft.command.CommandFluidPhysics.FLUID_PHYSICS_COMMAND_NAME;
