...
public class AtmosphereAccessorBuilder extends MinecraftVec3NodeBuilder<IAtmosphereAccessor, AtmosphereAccessorNode> {

    public AtmosphereAccessorBuilder(@Nonnull final String name) {
        super(name);
    }

    public AtmosphereAccessorBuilder(@Nonnull final String parentName, @Nonnull final String childName) {
