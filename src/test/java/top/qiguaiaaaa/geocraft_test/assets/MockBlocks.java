...
import top.qiguaiaaaa.geocraft_test.world.sandbox.Sandbox;
...
public final class MockBlocks {
    ...
    public static final MockSandboxEnvBuilder<?> BUILDER_ALL;
    ...
    public static final class Bases{
        ...
        public static BlockAir AIR = new BlockAir(){{ /// @see net.minecraft.init.Blocks#AIR
            this.setRegistryName(GeoCraftTest.MODID, "air");
            registerToMinecraft("AIR",0,this);
        }};
        public static BlockStone STONE = new BlockStone(){{
            this.setSoundType(SoundType.STONE).setHardness(1.5F).setResistance(10.0F).setRegistryName(GeoCraftTest.MODID, "stone");
            registerToMinecraft("STONE",1,this);
        }};
        public static BlockSoilDirt DIRT = new BlockSoilDirt(){{
            registerToMinecraft("DIRT",3,this.setHardness(0.5F).setRegistryName(GeoCraftTest.MODID,"dirt"));
        }};
        ...
        static {
            BUILDER = MockSandboxEnvBuilder.create("Basic Blocks").withStateData(Bases.class);
        }
    }
    ...
    public static final class VanillaFluids {
        ...
        public static final BlockObsidian OBSIDIAN = new BlockObsidian(){{
            registerToMinecraft("OBSIDIAN",49, this.setSoundType(SoundType.STONE)
                    .setHardness(50.0F).setResistance(2000.0F).setRegistryName(GeoCraftTest.MODID,"obsidian")); /// @see Blocks#OBSIDIAN
        }};
    ...
    public static final class GeoSnows{
        public static final BlockSnowMoreReality SNOW = new BlockSnowMoreReality(){{
            this.setSoundType(SoundType.SNOW).setLightOpacity(0).setRegistryName(GeoCraftTest.MODID,"snow_layer").setHardness(0.1F);
