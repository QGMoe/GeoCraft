 ...
 * @author QGMoe
 */
public final class NBTCompoundMatcher extends NBTMatcher<NBTTagCompound> {

    private final Map<String,NBTMatcher<?>> map = new HashMap<>();

    @Nonnull
    public Set<String> getKeysToMatch(){
        return map.keySet();
    }

    @Nonnull
    public Collection<NBTMatcher<?>> getValueMatchers(){
        return map.values();
    }
