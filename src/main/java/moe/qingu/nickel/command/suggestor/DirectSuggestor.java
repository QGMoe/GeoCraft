...
@FunctionalInterface
public
interface DirectSuggestor<P> extends Suggestor<P> {

    @Nonnull
    static <P> DirectSuggestor<P> of(final @Nonnull DirectSuggestor<P> provider) {
        return provider;
    }
    ...
    @Nonnull
    static <P> Static<P> of(final @Nonnull String... data) {
        return of(Arrays.stream(data));
    }

    @Nonnull
    static <P> Static<P> of(final @Nonnull Iterable<String> data) {
        return of(StreamSupport.stream(data.spliterator(), false));
    }

    @Nonnull
    static <P> Static<P> of(final @Nonnull Iterator<String> data) {
