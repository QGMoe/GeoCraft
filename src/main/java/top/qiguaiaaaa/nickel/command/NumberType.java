...
import top.qiguaiaaaa.nickel.command.builder.parameter.num.ComparableNumberNodeBuilder;
import top.qiguaiaaaa.nickel.command.builder.parameter.num.NumberNodeBuilder;
import top.qiguaiaaaa.nickel.command.node.parameter.generic.number.BigDecimalNode;
import top.qiguaiaaaa.nickel.command.node.parameter.generic.number.BigIntegerNode;
import top.qiguaiaaaa.nickel.command.node.parameter.generic.number.DoubleNode;
import top.qiguaiaaaa.nickel.command.node.parameter.generic.number.IntegerNode;
import top.qiguaiaaaa.nickel.command.node.parameter.generic.number.LongNode;
