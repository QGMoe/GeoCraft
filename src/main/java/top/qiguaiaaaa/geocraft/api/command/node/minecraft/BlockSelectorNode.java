 ...
 * @author QiguaiAAAA
 */
public class BlockSelectorNode extends SmartParameterNode<Block> {
    ...
    public static final BiFunction<List<String>, SuggestContext,List<String>> DEFAULT_SUGGESTOR =
            ((args, context) -> Block.REGISTRY.getKeys().stream().map(Objects::toString).collect(Collectors.toList()));
