 ...
 * @author QiguaiAAAA
 */
public class 大范围原版物理压强广搜任务 extends 大范围物理压强广搜任务 implements IRealityVanillaPressureBFSTask{
    protected final byte beginQuanta;

    大范围原版物理压强广搜任务(@Nonnull Fluid fluid, @Nonnull IBlockState beginState, @Nonnull BlockPos beginPos, int searchRange) {
    ...
    static class Debug extends 大范围原版物理压强广搜任务 implements IRealityDebugPressureBFSTask.IRealityVanillaDebugPressureBFSTask {
