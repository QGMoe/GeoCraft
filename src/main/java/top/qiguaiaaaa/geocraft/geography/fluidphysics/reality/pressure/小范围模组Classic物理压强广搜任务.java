...
package top.qiguaiaaaa.geocraft.geography.fluidphysics.reality.pressure;
...
/**
 * @see IRealityModClassicPressureBFSTask
 * @author QiguaiAAAA
 */
public class 小范围模组Classic物理压强广搜任务 extends 小范围物理压强广搜任务 implements IRealityModClassicPressureBFSTask{
    protected final byte beginQuanta;
    protected final byte quantaPerBlock;
    protected final byte densityDir;

    小范围模组Classic物理压强广搜任务(@Nonnull Fluid fluid, @Nonnull IBlockState beginState, @Nonnull BlockPos beginPos, int searchRange, int quantaPerBlock) {
    ...
    static class Debug extends 小范围模组Classic物理压强广搜任务 implements IRealityDebugPressureBFSTask.IRealityModClassicDebugPressureBFSTask {
